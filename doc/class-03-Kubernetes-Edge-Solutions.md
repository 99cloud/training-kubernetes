...
3. EdgeX Foundry 在哪些方面优化时延问题？
4. C 比 golang 性能好，原因是啥？

    C：程序员可以自己管理内存的分配和释放

    golang：使用 GC（垃圾收集器），编译器自己实现内存的分配和过期内存的回收

5. 通常而言，在一个边缘计算应用的场景中，都需要哪些参与方，各方的职责及提供的内容是什么？
6. 在工程实践中，边缘计算哪些方面标准化不足，最亟需标准化的是哪些方面？

    MP2 / MM5 接口

7. EdgeXFoundry 与 kubeEdge 面向物联网需求场景有何差异性？
...
9. JWT 令牌的优势是什么？
    ...
    - 资源服务可以不依赖认证服务即可完成授权
10. k3s/k8s 对 arm 的支持如何？

    均支持

11. EdgeXFoundry 如何保证安全性
...
12. 随着 AIOps 工具和流程的成熟，云计算行业对运维人员的需求点在哪里
    - 相关业务经验
    - 具有AI能力
13. k3s 有什么好用的工具书或者网站吗？

    同问题 69

14. kubedge 在物联网方面的应用有什么？
